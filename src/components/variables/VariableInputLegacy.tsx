...
/**
 * @deprecated Use EnhancedVariableInput instead. This component will be removed in a future version.
 */
    ...
    <Box>
      <Alert severity="warning" sx={{ mb: 2 }} icon={<Warning />}>
        <Typography variant="body2">
          This component is deprecated. Please use EnhancedVariableInput for better usability and new features.
        </Typography>
      </Alert>
